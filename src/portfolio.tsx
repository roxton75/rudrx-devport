      ...
      >
        <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
          ...
          <p className="text-gray-400 text-sm md:text-base text-justify">
            Im a passionate developer cum designer with a focus on creating
            efficient and elegant solutions. With experience in Android
            development and a strong foundation in 3D and other programming
            languages, I enjoy tackling challenges and continuously expanding my
            skill set. Whether it&apos;s building mobile applications or
        ...
        <div className="space-y-8 md:space-y-12">
          <div className="relative flex flex-col md:flex-row items-start gap-4 md:gap-6">
            ...
            <div className="flex-1 flex flex-col md:flex-row gap-4 md:gap-40">
              ...
              <div className="flex-1 space-y-2 text-gray-300 text-sm md:text-base ml-6 md:ml-0">
                ...
                <p>
                  • Optimized UI and UX design elements based on client&apos;s
                  feedback reviews.
                </p>
                <p>
                  • Contributed to the development of new features by
                  researching innovative technologies and frameworks.
                </p>
                <p>
                  • Assisted in designing user interfaces with XML layouts,
                  widgets, and custom components.
                </p>
                <p>
                  • Developed a prototype of an Android application to
                  demonstrate the use of various APIs.
                </p>
                <p>
                  • Integrated third-party services such as Google Maps API into
                  existing mobile apps.
                </p>
                <p>
                  • Implemented functionality using Java programming and Android
                  SDKs.
                </p>
              </div>
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-start gap-4 md:gap-6">
            ...
            <div className="flex-1 flex flex-col md:flex-row gap-4 md:gap-40">
              ...
              <div className="flex-1 space-y-2 text-gray-300 text-sm md:text-base ml-6 md:ml-0">
                <p className="mb-2">
                  3D Modeling in blender for assets like car model and a night
                  landscape :
                </p>
                <p>
                  • Created 3D models of assets and environments for clients up
                  to their needs.
                </p>
                <p>
                  • Rendered textures, materials, lighting, and shading for 3D
                  models in Blender 3D.
                </p>
                <p>
                  • Edited UV maps on complex geometry to reduce stretching or
                  other artifacts when texturing.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-start">
          <div className="flex-1 space-y-4 md:space-y-6 order-2 lg:order-1">
            <p className="text-gray-300 leading-relaxed text-justify text-sm md:text-base">
              ...
              Android development and 3D design. I enjoy creating efficient and
              innovative solutions, whether it&apos;s through mobile app
              development, UI/UX improvements, or exploring new technologies
              like AI. With a keen interest in both technical and creative
              fields, I continuously strive to enhance my skills and adapt to
              the ever-evolving tech landscape. My strengths lie in
              problem-solving, adaptability, and a commitment to delivering
              high-quality work.
            </p>
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm md:text-base">
                  ...
                  <li className="text-cyan-400">• Cross Platform Development</li>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex space-x-4">
              <Link
                href="https://linkedin.com/in/rudrx75"
              ...
              <Link
                href="https://www.instagram.com/rudrx_75/"
                className="bg-black rounded-full p-2"
              >
